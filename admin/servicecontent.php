...
if(isset($_POST['submit'])){
    ...
    // $pro_img_name1 = $_FILES["back_image"]["name"];
    // $pro_temp_name1 = $_FILES["back_image"]["tmp_name"];
    // $back_image ="images1/upload/".$pro_img_name1;
    // move_uploaded_file($pro_temp_name1,$back_image);
    // if($pro_img_name1==''){
    ...
    if($id>0){
        $query="UPDATE `service` SET `heading`='$heading',`content`='$content',`service_img`='$service_img' WHERE `service_id`='$id'";
    }
    else{
        $query="INSERT INTO `service`(`service_id`, `heading`, `content`, `service_img`) VALUES ('','$heading','$content','$service_img')";
    }
        ...
        <div class="container py-5">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <input type="file" value="<?php echo $service_img?>" name="service_img"
                            class="form-control" />
                    </div>
                    <div class="col-md-2"></div>
                </div><br />
